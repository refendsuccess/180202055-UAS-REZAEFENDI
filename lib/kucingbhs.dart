...
import 'package:hewan/kucinginggris.dart';
import 'package:hewan/kucingragdoll.dart';
import 'package:flutter/material.dart';

class Kucingbhs extends StatefulWidget {
  @override
  _KucingbhsState createState() => _KucingbhsState();
}

class _KucingbhsState extends State<Kucingbhs> {
  @override
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Kucingindo()),
                  );
                },
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Kucinginggris()),
                  );
                },
                color: Colors.purple[200],
                textColor: Colors.purple,
