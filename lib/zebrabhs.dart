...
import 'package:hewan/zebrainggris.dart';

class Zebrabhs extends StatefulWidget {
  @override
  _ZebrabhsState createState() => _ZebrabhsState();
}

class _ZebrabhsState extends State<Zebrabhs> {
  @override
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Zebrainggris()),
                  );
                },
                color: Colors.purple[200],
                textColor: Colors.purple,
