...
import 'package:hewan/kudainggris.dart';
import 'package:hewan/kudaponi.dart';
import 'package:flutter/material.dart';

class Kudabhs extends StatefulWidget {
  @override
  _KudabhsState createState() => _KudabhsState();
}

class _KudabhsState extends State<Kudabhs> {
  @override
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Kudainggris()),
                  );
                },
                color: Colors.purple[200],
                textColor: Colors.purple,
